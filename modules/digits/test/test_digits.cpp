...
TEST(Smetanin_Danila_DigitsTest, canInitDigitClass) {
    // Arrange
...
TEST(Smetanin_Danila_DigitsTest, canGetNumberIntoArray) {
    // Arrange
    Digits Init;
    int n = 910;
    int mas[4] = { 3, 0, 1, 9 };
...
TEST(Smetanin_Danila_DigitsTest, DigitNumberIsEqualToHis) {
    // Arrange
    Digits Init;
    std::string line[3];
    int n = 910;
...
TEST(Smetanin_Danila_DigitsTest, DigitFirstLineStringIsEqualToThis) {
    // Arrange
    Digits Init;
...
TEST(Smetanin_Danila_DigitsTest, GetFullNumberIntoString) {
    // Arrange
    Digits Init;
    std::string line[3];
    std::string number;
