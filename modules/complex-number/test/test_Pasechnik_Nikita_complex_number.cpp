...
TEST(Pasechnik_Nikita_ComplexNumberTest, Multi_By_Zero_Is_Zero) {
    // Arrange
...
TEST(Pasechnik_Nikita_ComplexNumberTest, Sum_Commutication) {
    // Arrange
...
TEST(Pasechnik_Nikita_ComplexNumberTest, Sum_Of_Equal_By_Abs_Is_Zero) {
    // Arrange
